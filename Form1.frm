...
Begin VB.Form Form1 
   ...
   Begin Project1.uListBox lstComplete 
      ...
      ForeColor       =   16711680
      Text            =   ""
      SelectionBackgroundColor=   16761024
...
Private Sub Text1_KeyDown(KeyCode As Integer, Shift As Integer)
    ...
    If KeyCode = vbKeySpace And Shift = 2 Then
        ...
        If lstComplete.Visible Then
            ...
            If wordNr = -1 Then Exit Sub
            
            If lstComplete.ListIndex >= 0 And lstComplete.ListIndex < lstComplete.ListCount Then
                Text1.SelStart = Text1.getWordStart(wordNr)
                Text1.SelLength = Text1.getWordLength(wordNr)
                Text1.AddCharAtCursor lstComplete.List(lstComplete.ListIndex)
            End If
        ...
        Else
            ...
            End If
        End If
    ElseIf (KeyCode = vbKeyUp Or KeyCode = vbKeyDown) And lstComplete.Visible Then
        
        If KeyCode = vbKeyUp Then
            If lstComplete.ListIndex > 0 Then
                lstComplete.ListIndex = lstComplete.ListIndex - 1
            End If
            
        ElseIf KeyCode = vbKeyDown Then
            If lstComplete.ListIndex < lstComplete.ListCount - 1 Then
                lstComplete.ListIndex = lstComplete.ListIndex + 1
            End If
...
Function RefillAutocomplete() As Long
    ...
    If lstComplete.ListCount = 0 Then
        lstComplete.Visible = False
    Else
        'lstComplete.ItemColor(0) = vbBlack
